...
To learn interpretable embeddings and topics using ETM on the reddit dataset, run
```
python main.py --mode train --dataset reddit --data_path data/reddit --num_topics 50 --train_embeddings 1 --epochs 100 --anneal_lr 1 --wdecay 
```

To evaluate perplexity on document completion, topic coherence, topic diversity, and visualize the topics/embeddings run
```
python main.py --mode eval --dataset reddit --data_path data/reddit --num_topics 50 --train_embeddings 1 --tc 1 --td 1 --load_from results/etm_reddit_K_50_Htheta_800_Optim_adam_Clip_0.0_ThetaAct_relu_Lr_0.005_Bsz_1000_RhoSize_300_trainEmbeddings_1
